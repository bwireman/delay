...
export function sizedInt(int: number, size: number, isBigEndian: boolean): Uint8Array
...
export function byteArrayToFloat(byteArray: Uint8Array, start: number, end: number, isBigEndian: boolean): number

export function stringBits(string: string): Uint8Array

export function codepointBits(codepoint: UtfCodepoint): Uint8Array

export function sizedFloat(float: number, size: number, isBigEndian: boolean): Uint8Array
