// copy of https://github.com/gleam-lang/gleam/blob/v1.8.0/compiler-core/templates/prelude.mjs
// ---
//                                 Apache License
...
export class BitArray {
  ...
  binaryFromSlice(start, end) {
    const buffer = new Uint8Array(this.buffer.buffer, this.buffer.byteOffset + start, end - start)
    return new BitArray(buffer)
  }

  // @internal
  sliceAfter(index) {
    const buffer = new Uint8Array(this.buffer.buffer, this.buffer.byteOffset + index, this.buffer.byteLength - index)
    return new BitArray(buffer)
  }
}
